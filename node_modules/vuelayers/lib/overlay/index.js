...
var props = {
  ...
  positioning: {
    ...
    validator: function validator(value) {
      ...
      return _includesInstanceProperty(_context = _Object$values(OVERLAY_POSITIONING)).call(_context, value);
    }
  },
  stopEvent: {
    type: Boolean,
...
var computed = {
  ...
  classes: function classes() {
    ...
    return _filterInstanceProperty(_context2 = [this.cmpName, this.visible ? 'visible' : undefined]).call(_context2, identity);
  }
};
var methods = {
  /**
  ...
  mount: function mount() {
    ...
    this.$nextTick(function () {
      ...
      _this.$overlay.setPosition(_sliceInstanceProperty(_context3 = _this.positionViewProj).call(_context3));
