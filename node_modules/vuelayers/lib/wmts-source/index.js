...
import { createExtentFromProjection, EXTENT_CORNER, getExtentCorner, resolutionsFromExtent, WMTS_FORMAT, WMTS_REQUEST_ENCODING, WMTS_VERSION } from '../ol-ext';
...
var script = {
  ...
  methods: {
    ...
    createTileGrid: function createTileGrid() {
      ...
      var matrixIds = this.matrixIds || _Array$from(range(this.minZoom, resolutions.length));
    ...
    onUrlFuncChange: function onUrlFuncChange() {}
  },
  watch: _objectSpread({
    urlTmpl: function urlTmpl(value) {
      if (!this.$source) return;
      this.$source.setUrl(value);
    }
  }, makeWatchers(['dimensions', 'format', 'layerName', 'matrixSet', 'requestEncoding', 'styleName', 'version', 'resolutions', 'origin'], function () {
    return function () {
