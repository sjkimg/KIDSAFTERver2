...
var _cleanExtParams = function cleanExtParams(params) {
  return reduce(params, function (params, value, key) {
    ...
    if (_includesInstanceProperty(filterKeys).call(filterKeys, key)) {
      return params;
    }
...
var methods = {
  ...
  getFeatureInfoUrl: function getFeatureInfoUrl(coordinate, resolution, projection) {
    ...
    params = _objectSpread(_objectSpread({}, this.allParams), params);
    return this.$source.getGetFeatureInfoUrl(coordinate, resolution, projection, params);
  }
};

var watch = _objectSpread(_objectSpread({}, makeWatchers(['layers', 'version', 'styles', 'transparent', 'format', 'bgColor', 'time'], function (prop) {
