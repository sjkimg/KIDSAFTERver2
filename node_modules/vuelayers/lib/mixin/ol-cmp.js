        ...
        return _regeneratorRuntime.wrap(function _callee$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return _this.instanceFactoryCall(_this.olObjIdent, _bindInstanceProperty(_context3 = _this.createOlObject).call(_context3, _this));

              case 2:
                _this._olObject = _context5.sent;
                _this._olObject[VM_PROP] || (_this._olObject[VM_PROP] = []);

                if (!_includesInstanceProperty(_context4 = _this._olObject[VM_PROP]).call(_context4, _this)) {
