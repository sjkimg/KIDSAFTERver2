...
var rxSubs = {
  methods: {
    ...
    unsubscribeAll: function unsubscribeAll() {
      ...
      _forEachInstanceProperty(_context = this._rxSubs).call(_context, function (x) {
    ...
    unsubscribe: function unsubscribe(subs) {
      ...
      var idx = _indexOfInstanceProperty(_context2 = this._rxSubs).call(_context2, subs);

      if (idx === -1) return;
      subs.unsubscribe();

      _spliceInstanceProperty(_context3 = this._rxSubs).call(_context3, idx, 1);
    }
  },
