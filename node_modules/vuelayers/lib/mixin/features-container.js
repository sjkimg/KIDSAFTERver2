...
var featuresContainer = {
  ...
  computed: {
    ...
    featuresViewProj: function featuresViewProj() {
      ...
      if (!this.rev) return [];
      return _mapInstanceProperty(_context2 = this.getFeatures()).call(_context2, _bindInstanceProperty(_context3 = this.writeFeatureInViewProj).call(_context3, this));
    },
    featuresDataProj: function featuresDataProj() {
      var _context4, _context5;

      if (!this.rev) return [];
      return _mapInstanceProperty(_context4 = this.getFeatures()).call(_context4, _bindInstanceProperty(_context5 = this.writeFeatureInDataProj).call(_context5, this));
    },
  ...
  methods: {
    ...
    addFeatures: function addFeatures(features) {
      ...
      forEach(features, _bindInstanceProperty(_context6 = this.addFeature).call(_context6, this));
    },
    ...
    removeFeatures: function removeFeatures(features) {
      ...
      forEach(features, _bindInstanceProperty(_context7 = this.removeFeature).call(_context7, this));
    },
    ...
    getFeatureById: function getFeatureById(featureId) {
      ...
      return _findInstanceProperty(_context8 = this.$featuresCollection.getArray()).call(_context8, function (feature) {
