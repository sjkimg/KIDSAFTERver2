...
import { constant, difference, isEqual, isFinite, isFunction, stubArray, isArray, isString, pick } from '../util/minilo';
...
var script = {
  ...
  computed: {
    ...
    dataFormat: function dataFormat() {
      ...
      return this.instanceFactoryCall(this.dataFormatIdent, _bindInstanceProperty(_context3 = this.formatFactory).call(_context3, this));
    }
  },
  methods: {
    /**
