...
var script = {
  ...
  computed: {
    ...
    layerFilter: function layerFilter() {
      ...
      return _Array$isArray(this.layers) ? function (layer) {
        var _context2;

        return _includesInstanceProperty(_context2 = _this.layers).call(_context2, getLayerId(layer));
      } : this.layers;
    }
  },
  methods: {
    ...
    createInteraction: function createInteraction() {
      return new SelectInteraction({
        ...
        multi: this.multi,
        wrapX: this.wrapX,
        filter: _filterInstanceProperty(this),
    ...
    mount: function mount() {
      ...
      _forEachInstanceProperty(_context3 = this.features).call(_context3, this.select);
    },
  ...
  watch: _objectSpread({
    initializedFeature: {
      ...
      handler: function handler(features) {
        ...
        _forEachInstanceProperty(features).call(features, _bindInstanceProperty(_context4 = this.select).call(_context4, this)); // unselect non-matched features


        _forEachInstanceProperty(_context5 = difference(this.getFeatures(), features, function (a, b) {
          return getFeatureId(a) === getFeatureId(b);
        })).call(_context5, _bindInstanceProperty(_context6 = this.unselect).call(_context6, this));
      }
    },
    featuresDataProj: {
      deep: true,
...
function subscribeToInteractionChanges() {
  ...
  hasInteraction(this);
  var select = observableFromOlEvent(this.$featuresCollection, 'add').pipe(map(function (_ref) {
  ...
  var unselect = observableFromOlEvent(this.$featuresCollection, 'remove').pipe(map(function (_ref2) {
