...
import { ok, hasSource } from '../util/assert';
...
var Builder = /*#__PURE__*/function () {
  ...
  _createClass(Builder, [{
    ...
    value: function set(key, value) {
      _valuesInstanceProperty(this) || (this.values = {});
      _valuesInstanceProperty(this)[key] = value;
    }
    /**
     * @return {Cluster}
     */
    ...
    value: function build() {
      ...
      source.setProperties(_valuesInstanceProperty(this));
      return source;
    }
    /**
    ...
    value: function promise() {
      ...
      return interval(100).pipe(skipWhile(function () {
        return !_this.source;
      }), first(), map(_bindInstanceProperty(_context = this.build).call(_context, this))).toPromise(_Promise);
    }
  }]);
...
function subscribeToSourceChanges() {
  ...
  hasSource(this);
  var adds = observableFromOlEvent(this.$source, 'addfeature');
  this.subscribeTo(adds, function (_ref) {
    var feature = _ref.feature;

    _this.addFeature(feature);
  });
  var removes = observableFromOlEvent(this.$source, 'removefeature');
